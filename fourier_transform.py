...
footer_table_container = st.container()


# 2. Your existing functions and app logic go here
def render_fourier_section():
    st.title("Main Section Content")
    st.write("This content stays in the middle of the page.")


# Call your normal functions
render_fourier_section()


# 3. Write the table inside the container at the end of the script execution
with footer_table_container:
